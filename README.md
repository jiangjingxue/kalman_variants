...
<img src="./doc/ekf.gif" width="360" height="270" style="border-radius: 10px; display: block; margin: auto; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%) box-shadow: 0 0 10px rgba(0, 0, 0, 0.2);">
